...
module SB(
  ...
  wire [3:0][3:0]  _GEN_1 = {{sb_wstrb_3}, {sb_wstrb_2}, {sb_wstrb_1}, {sb_wstrb_0}};
  ...
  reg  [3:0]       ld_hit_mask;
  reg  [3:0]       hit_index;
  wire [31:0]      _hit_byte_T_4 = hit_index[0] ? sb_order_reg_data_0 : 32'h0;
  wire [31:0]      _hit_byte_T_5 = hit_index[1] ? sb_order_reg_data_1 : 32'h0;
  wire [31:0]      _hit_byte_T_6 = hit_index[2] ? sb_order_reg_data_2 : 32'h0;
  wire [31:0]      _hit_byte_T_7 = hit_index[3] ? sb_order_reg_data_3 : 32'h0;
  reg  [1:0]       hit_byte_r;
  wire [31:0]      hit_byte =
  ...
  reg              io_ld_hit_0_r;
  reg  [3:0]       hit_index_1;
  wire [31:0]      _hit_byte_T_18 = hit_index_1[0] ? sb_order_reg_data_0 : 32'h0;
  wire [31:0]      _hit_byte_T_19 = hit_index_1[1] ? sb_order_reg_data_1 : 32'h0;
  wire [31:0]      _hit_byte_T_20 = hit_index_1[2] ? sb_order_reg_data_2 : 32'h0;
  wire [31:0]      _hit_byte_T_21 = hit_index_1[3] ? sb_order_reg_data_3 : 32'h0;
  ...
  reg              io_ld_hit_1_r;
  reg  [3:0]       hit_index_2;
  wire [31:0]      _hit_byte_T_32 = hit_index_2[0] ? sb_order_reg_data_0 : 32'h0;
  wire [31:0]      _hit_byte_T_33 = hit_index_2[1] ? sb_order_reg_data_1 : 32'h0;
  wire [31:0]      _hit_byte_T_34 = hit_index_2[2] ? sb_order_reg_data_2 : 32'h0;
  wire [31:0]      _hit_byte_T_35 = hit_index_2[3] ? sb_order_reg_data_3 : 32'h0;
  ...
  reg              io_ld_hit_2_r;
  reg  [3:0]       hit_index_3;
  wire [31:0]      _hit_byte_T_46 = hit_index_3[0] ? sb_order_reg_data_0 : 32'h0;
  wire [31:0]      _hit_byte_T_47 = hit_index_3[1] ? sb_order_reg_data_1 : 32'h0;
  wire [31:0]      _hit_byte_T_48 = hit_index_3[2] ? sb_order_reg_data_2 : 32'h0;
  wire [31:0]      _hit_byte_T_49 = hit_index_3[3] ? sb_order_reg_data_3 : 32'h0;
  ...
  wire [3:0]       sb_order_wstrb_3 = _GEN_1[rear];
  wire             ld_hit_temp_0 =
  ...
  wire [3:0]       _hit_T_13 = sb_order_wstrb_3 >> _GEN_21;
  ...
  wire [3:0]       _hit_T_29 = sb_order_wstrb_3 >> _GEN_22;
  ...
  wire [3:0]       _hit_T_45 = sb_order_wstrb_3 >> _GEN_23;
  ...
  wire [3:0]       _hit_T_61 = sb_order_wstrb_3 >> _GEN_24;
  ...
  wire             _GEN_29 = clear | ~_GEN_28;
  wire             _GEN_30 = _GEN_25 & rear == 2'h2;
  wire             _GEN_31 = clear | ~_GEN_30;
  wire             _GEN_32 = _GEN_25 & (&rear);
  wire             _GEN_33 = clear | ~_GEN_32;
  always @(posedge clock) begin
    ...
    if (io_em_stall) begin
      ...
      sb_order_reg_data_3 <= _GEN_0[rear];
