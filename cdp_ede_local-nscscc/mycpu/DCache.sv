...
module DCache(
  ...
  reg             dt_1_30;
  reg             dt_1_31;
  wire [4:0]      tagmem_addrb_0 = addr_sel ? addr_RF_EX[9:5] : io_addr_RF[9:5];
  wire [22:0]     tagmem_dina_1 = {1'h1, addr_EX_MEM[31:10]};
  wire [4:0]      tagmem_addrb_1 = addr_sel ? addr_RF_EX[9:5] : io_addr_RF[9:5];
  wire [4:0]      datamem_addrb_0 = addr_sel ? addr_RF_EX[9:5] : io_addr_RF[9:5];
  wire [4:0]      datamem_addrb_1 = addr_sel ? addr_RF_EX[9:5] : io_addr_RF[9:5];
  ...
  wire [255:0]    datamem_dina_1 = w_mask & refill_temp[255:0] | ~w_mask & rbuf;
