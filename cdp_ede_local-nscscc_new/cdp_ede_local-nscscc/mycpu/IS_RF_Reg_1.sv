...
module IS_RF_Reg_1(
  ...
  input         io_inst_pack_IS_alu_rs1_sel,
  input  [1:0]  io_inst_pack_IS_alu_rs2_sel,
  ...
  output        io_inst_pack_RF_alu_rs1_sel,
  output [1:0]  io_inst_pack_RF_alu_rs2_sel,
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      inst_pack_reg_prj <= io_flush ? 6'h0 : io_inst_pack_IS_prj;
      inst_pack_reg_prk <= io_flush ? 6'h0 : io_inst_pack_IS_prk;
      inst_pack_reg_rd_valid <= ~io_flush & io_inst_pack_IS_rd_valid;
      inst_pack_reg_prd <= io_flush ? 6'h0 : io_inst_pack_IS_prd;
      inst_pack_reg_imm <= io_flush ? 32'h0 : io_inst_pack_IS_imm;
      inst_pack_reg_rob_index <= io_flush ? 5'h0 : io_inst_pack_IS_rob_index;
      inst_pack_reg_alu_op <= io_flush ? 4'h0 : io_inst_pack_IS_alu_op;
      inst_pack_reg_alu_rs1_sel <= ~io_flush & io_inst_pack_IS_alu_rs1_sel;
