...
module CSR_Regfile(
  ...
  wire [31:0] _GEN_8 =
    io_raddr == 14'h10 | io_raddr == 14'h11 | io_raddr == 14'h12 | io_raddr == 14'h13
    | io_raddr == 14'h18
      ? 32'h0
      : _GEN_7;
  wire [31:0] _GEN_9 = io_raddr == 14'h60 ? llbctl : _GEN_8;
  wire [31:0] _GEN_10 = io_raddr == 14'h33 ? data3 : _GEN_9;
  wire [31:0] _GEN_11 = io_raddr == 14'h32 ? data2 : _GEN_10;
  wire [31:0] _GEN_12 = io_raddr == 14'h31 ? data1 : _GEN_11;
  wire [31:0] _GEN_13 = io_raddr == 14'h30 ? data0 : _GEN_12;
  wire [31:0] _GEN_14 = io_raddr == 14'h20 ? coreid : _GEN_13;
  wire [31:0] _GEN_15 = io_raddr == 14'hC ? eentry : _GEN_14;
  wire [31:0] _GEN_16 = io_raddr == 14'h7 ? badv : _GEN_15;
  wire [31:0] _GEN_17 = io_raddr == 14'h6 ? era : _GEN_16;
  wire [31:0] _GEN_18 = io_raddr == 14'h5 ? estat : _GEN_17;
  wire [31:0] _GEN_19 = io_raddr == 14'h4 ? ecfg : _GEN_18;
  wire [31:0] _GEN_20 = io_raddr == 14'h2 ? euen : _GEN_19;
  wire [31:0] _GEN_21 = io_raddr == 14'h1 ? prmd : _GEN_20;
  wire [30:0] _GEN_22 =
  ...
  always @(posedge clock) begin
    if (reset) begin
      ...
      timer_reg <=
        ...
        & (tcfg[0] & _GEN_23 & tval_edge == 32'h1 | timer_reg);
  ...
  assign io_rdata = io_raddr == 14'h0 ? crmd : _GEN_21;
