...
module mycpu_top(
  ...
  assign debug_wb_pc = io_commit_pc_0;
  assign debug_wb_rf_we = {io_commit_rd_valid_0, io_commit_rd_valid_0, io_commit_rd_valid_0, io_commit_rd_valid_0};
  assign debug_wb_rf_wnum = io_commit_rd_0;
  assign debug_wb_rf_wdata = io_commit_rf_wdata_0;
  ...
  wire [7:0]       inst_pack_IF_exception =
    _pi_reg_io_inst_pack_IF_0_exception[7] ? _pi_reg_io_inst_pack_IF_0_exception : 8'h0;
  wire [7:0]       inst_pack_IF_1_exception =
    _pi_reg_io_inst_pack_IF_1_exception[7] ? _pi_reg_io_inst_pack_IF_1_exception : 8'h0;
  ...
  assign _pi_reg_io_stall = _pi_reg_io_stall_T | _icache_io_has_cacop_IF;
  assign _pi_reg_io_inst_pack_PF_1_pc = 32'(_pc_io_pc_PF_8 + 32'h4);
  PF_IF_Reg pi_reg (
    .clock                          (clock),
    .reset                          (reset),
    .io_flush                       (_pi_reg_io_flush),
    .io_stall                       (_pi_reg_io_stall),
  ...
  ROB rob (
    ...
    .io_tlbfill_en_cmt         (io_commit_tlbfill_en),
