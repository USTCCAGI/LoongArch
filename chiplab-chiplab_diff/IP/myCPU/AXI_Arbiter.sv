...
module AXI_Arbiter(
  ...
  wire            _GEN_4 = _GEN | _GEN_0 | _GEN_1 | ~_GEN_3;
  ...
  assign io_araddr = _GEN_4 ? io_i_araddr : io_d_araddr;
  assign io_arlen = _GEN_4 ? io_i_rlen : io_d_rlen;
  assign io_arsize = _GEN_4 ? 3'h2 : io_d_rsize;
